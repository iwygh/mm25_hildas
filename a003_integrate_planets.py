...
for iobj in range(nplanets):
    idhere = ids[iobj]
    GM = GM_list[iobj]
    # horizons = Horizons(id=idhere,location='500@sun',epochs=jd)
...
del sim
del starting_sim
# np.savetxt('005_a_planets_x_barycentric_' + yrsstr + '.csv',x_mat_planets,delimiter=',')
# np.savetxt('005_a_planets_y_barycentric_' + yrsstr + '.csv',y_mat_planets,delimiter=',')
# np.savetxt('005_a_planets_z_barycentric_' + yrsstr + '.csv',z_mat_planets,delimiter=',')
# np.savetxt('005_a_planets_vx_barycentric_' + yrsstr + '.csv',vx_mat_planets,delimiter=',')
# np.savetxt('005_a_planets_vy_barycentric_' + yrsstr + '.csv',vy_mat_planets,delimiter=',')
# np.savetxt('005_a_planets_vz_barycentric_' + yrsstr + '.csv',vz_mat_planets,delimiter=',')
#%%
