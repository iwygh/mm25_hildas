...
clone_labels = ['Ismene','Hilda','Schubart','Potomac']
...
# subplottitles = ['Potomac family Δ (deg)',   'Potomac clones Δ (deg)',\
#                  'Hilda family Δ (deg)',     'Hilda clones Δ (deg)',\
#                  'Schubart family Δ (deg)',  'Schubart clones Δ (deg)',\
#                  'Hilda group Δ (deg)','Ismene clones Δ (deg)']
subplottitles = ['Hilda group Δ (deg)','Ismene clones Δ (deg)',\
                 'Hilda family Δ (deg)',     'Hilda clones Δ (deg)',\
                 'Schubart family Δ (deg)',  'Schubart clones Δ (deg)',\
                 'Potomac family Δ (deg)',   'Potomac clones Δ (deg)',\
                 ]
for iax in [0,1,2,3,4,5,6,7]:
...
for iax in [0,2,4,6]:
    ...
    # ax[iax].semilogy(tyrsvec[:nt-averaging_window]/1e6,deltadeg_laplace_here_av,'r-',lw=0.25)
    # ax[iax].semilogy(tyrsvec[:nt-averaging_window]/1e6,deltadeg_jupiter_here_av,'b-',lw=0.25)
    # ax[iax].semilogy(tyrsvec[:nt-averaging_window]/1e6,deltadeg_invariable_here_av,'k-',lw=0.25)
...
for iax in [1,3,5,7]:
    ...
    # ax[iax].semilogy(tyrsvec/1e6,deltadeg_laplace_here,'r-',lw=0.25)
    # ax[iax].semilogy(tyrsvec/1e6,deltadeg_jupiter_here,'b-',lw=0.25)
    # ax[iax].semilogy(tyrsvec/1e6,deltadeg_invariable_here,'k-',lw=0.25)
    ax[iax].grid('on')
    # ax[iax].set_xlim([0,2])
    # ax[iax].set_ylim([0.01,10])
    # ax[iax].set_yticks([0.01,0.1,1])
...
# ax[6].set_ylim([0.01,10])
# ax[1].set_ylim([0.01,10])
# ax[3].set_ylim([0.01,10])
# ax[5].set_ylim([0.01,10])
# ax[7].set_ylim([0.01,10])
