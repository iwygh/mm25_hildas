...
# output_labels = ['S','H','P','BPHSFG']   
# plot_labels = ['Schubart','Hilda','Potomac','All']
# input_conditions = [['Schubart'],['Hilda'],['Potomac'],\
...
for icon in range(ncons):
    ...
    for irep in range(nreps):
        ...
        t1 = time.time()
        # print(icon+1,ncons,irep+1,nreps,(t1-t0)/60)
...
plt.savefig('b019_demo_vmf_histograms.png',dpi=400)
np.savetxt('b019_demo_vmf_xcc.csv',xcc_vecs,delimiter=',')
np.savetxt('b019_demo_vmf_ycc.csv',ycc_vecs,delimiter=',')
np.savetxt('b019_demo_vmf_zcc.csv',zcc_vecs,delimiter=',')
np.savetxt('b019_demo_vmf_angle_68_deg.csv',angle_68_deg_vecs,delimiter=',')
np.savetxt('b019_demo_vmf_angle_95_deg.csv',angle_95_deg_vecs,delimiter=',')
np.savetxt('b019_demo_vmf_angle_997_deg.csv',angle_997_deg_vecs,delimiter=',')
np.savetxt('b019_demo_vmf_Delta_deg.csv',Delta_deg_vecs,delimiter=',')
